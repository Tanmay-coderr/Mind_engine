                    ...
                    return (
                        ...
                        >
                            ...
                            <button
                                onClick={() => {
                                    if (domain === "career") {
                                        navigate("/careercourse"); // Redirect to Career_course.jsx route
                                    } else if (domain === "academic") {
                                        navigate("/academiccourse");
                                    } else if (domain === "finance") {
                                        navigate("/financialcourse");
                                    } else if (domain === "relationship") {
                                        navigate("/relationshipcourse");
                                    } else if (domain === "general") {
                                        navigate("/general-course");
                                    }
